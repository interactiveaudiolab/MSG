'''
Taken from https://github.com/eriklindernoren/PyTorch-GAN/tree/master/implementations/pix2pix
'''
...
class Discriminator2(nn.Module):
    def __init__(self, in_channels=3):
        ...
        self.conv1 = nn.Conv2d(in_channels * 2, 64, 4, stride=2, padding=1)
        ...
        self.zero_pad4 = nn.ZeroPad2d((1, 0, 1, 0))
        self.final_conv = nn.Conv2d(512, 1, 4, padding=1, bias=False)
